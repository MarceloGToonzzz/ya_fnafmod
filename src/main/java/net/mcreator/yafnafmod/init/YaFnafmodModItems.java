...
import net.mcreator.yafnafmod.item.MoneyBillWrapItem;
import net.mcreator.yafnafmod.item.MoneyBillItem;
...
public class YaFnafmodModItems {
	...
	public static final RegistryObject<Item> MONEY_BILL = REGISTRY.register("money_bill", () -> new MoneyBillItem());
	public static final RegistryObject<Item> MONEY_BILL_WRAP = REGISTRY.register("money_bill_wrap", () -> new MoneyBillWrapItem());
