...
import net.mcreator.yafnafmod.item.HookItem;
...
public class YaFnafmodModItems {
	...
	public static final RegistryObject<Item> PC = block(YaFnafmodModBlocks.PC);
	public static final RegistryObject<Item> PC_MONITOR = block(YaFnafmodModBlocks.PC_MONITOR);
	public static final RegistryObject<Item> FIRE_EXTINGUISHER_WALL = block(YaFnafmodModBlocks.FIRE_EXTINGUISHER_WALL);
	public static final RegistryObject<Item> ARCADE_RACING_PINK = REGISTRY.register(YaFnafmodModBlocks.ARCADE_RACING_PINK.getId().getPath(), () -> new ArcadeRacingPinkDisplayItem(YaFnafmodModBlocks.ARCADE_RACING_PINK.get(), new Item.Properties()));
	public static final RegistryObject<Item> ARCADE_RACING_BLUE = REGISTRY.register(YaFnafmodModBlocks.ARCADE_RACING_BLUE.getId().getPath(), () -> new ArcadeRacingBlueDisplayItem(YaFnafmodModBlocks.ARCADE_RACING_BLUE.get(), new Item.Properties()));
	public static final RegistryObject<Item> CARPETED_FLOOR_ARCADE_2 = block(YaFnafmodModBlocks.CARPETED_FLOOR_ARCADE_2);
	public static final RegistryObject<Item> CARPETED_FLOOR_ARCADE_2_STAIRS = block(YaFnafmodModBlocks.CARPETED_FLOOR_ARCADE_2_STAIRS);
	public static final RegistryObject<Item> CARPETED_FLOOR_ARCADE_2_SLAB = block(YaFnafmodModBlocks.CARPETED_FLOOR_ARCADE_2_SLAB);
	public static final RegistryObject<Item> CARPET_FLOOR_ARCADE_2 = block(YaFnafmodModBlocks.CARPET_FLOOR_ARCADE_2);
	...
	public static final RegistryObject<MnafGoldenFreddySuitItem> MNAF_GOLDEN_FREDDY_SUIT_CHESTPLATE = REGISTRY.register("mnaf_golden_freddy_suit_chestplate", () -> new MnafGoldenFreddySuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafGoldenFreddySuitItem> MNAF_GOLDEN_FREDDY_SUIT_LEGGINGS = REGISTRY.register("mnaf_golden_freddy_suit_leggings", () -> new MnafGoldenFreddySuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<MnafShadowFreddySuitItem> MNAF_SHADOW_FREDDY_SUIT_HELMET = REGISTRY.register("mnaf_shadow_freddy_suit_helmet", () -> new MnafShadowFreddySuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafShadowFreddySuitItem> MNAF_SHADOW_FREDDY_SUIT_CHESTPLATE = REGISTRY.register("mnaf_shadow_freddy_suit_chestplate", () -> new MnafShadowFreddySuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafShadowFreddySuitItem> MNAF_SHADOW_FREDDY_SUIT_LEGGINGS = REGISTRY.register("mnaf_shadow_freddy_suit_leggings", () -> new MnafShadowFreddySuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> HOOK = REGISTRY.register("hook", () -> new HookItem());
	public static final RegistryObject<Item> ANIMATRONIC_BOX_FREDDY = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_FREDDY);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_BONNIE = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_BONNIE);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_CHICA = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_CHICA);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_FOXY = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_FOXY);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_TOY_FREDDY = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_TOY_FREDDY);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_TOY_BONNIE = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_TOY_BONNIE);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_TOY_CHICA = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_TOY_CHICA);
	public static final RegistryObject<Item> ANIMATRONIC_BOX_TOY_FOXY = block(YaFnafmodModBlocks.ANIMATRONIC_BOX_TOY_FOXY);
	public static final RegistryObject<Item> TOY_FREDDY_HEAD = REGISTRY.register(YaFnafmodModBlocks.TOY_FREDDY_HEAD.getId().getPath(), () -> new ToyFreddyHeadDisplayItem(YaFnafmodModBlocks.TOY_FREDDY_HEAD.get(), new Item.Properties()));
	public static final RegistryObject<Item> TOY_BONNIE_HEAD = REGISTRY.register(YaFnafmodModBlocks.TOY_BONNIE_HEAD.getId().getPath(), () -> new ToyBonnieHeadDisplayItem(YaFnafmodModBlocks.TOY_BONNIE_HEAD.get(), new Item.Properties()));
	public static final RegistryObject<Item> TOY_CHICA_HEAD = REGISTRY.register(YaFnafmodModBlocks.TOY_CHICA_HEAD.getId().getPath(), () -> new ToyChicaHeadDisplayItem(YaFnafmodModBlocks.TOY_CHICA_HEAD.get(), new Item.Properties()));
	public static final RegistryObject<Item> TOY_FOXY_HEAD = REGISTRY.register(YaFnafmodModBlocks.TOY_FOXY_HEAD.getId().getPath(), () -> new ToyFoxyHeadDisplayItem(YaFnafmodModBlocks.TOY_FOXY_HEAD.get(), new Item.Properties()));
	public static final RegistryObject<MnafFredbearSuitItem> MNAF_FREDBEAR_SUIT_HELMET = REGISTRY.register("mnaf_fredbear_suit_helmet", () -> new MnafFredbearSuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafFredbearSuitItem> MNAF_FREDBEAR_SUIT_CHESTPLATE = REGISTRY.register("mnaf_fredbear_suit_chestplate", () -> new MnafFredbearSuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafFredbearSuitItem> MNAF_FREDBEAR_SUIT_LEGGINGS = REGISTRY.register("mnaf_fredbear_suit_leggings", () -> new MnafFredbearSuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<MnafSpringbonnieSuitItem> MNAF_SPRINGBONNIE_SUIT_HELMET = REGISTRY.register("mnaf_springbonnie_suit_helmet", () -> new MnafSpringbonnieSuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafSpringbonnieSuitItem> MNAF_SPRINGBONNIE_SUIT_CHESTPLATE = REGISTRY.register("mnaf_springbonnie_suit_chestplate", () -> new MnafSpringbonnieSuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafSpringbonnieSuitItem> MNAF_SPRINGBONNIE_SUIT_LEGGINGS = REGISTRY.register("mnaf_springbonnie_suit_leggings", () -> new MnafSpringbonnieSuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<MnafToyFreddySuitItem> MNAF_TOY_FREDDY_SUIT_HELMET = REGISTRY.register("mnaf_toy_freddy_suit_helmet", () -> new MnafToyFreddySuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafToyFreddySuitItem> MNAF_TOY_FREDDY_SUIT_CHESTPLATE = REGISTRY.register("mnaf_toy_freddy_suit_chestplate", () -> new MnafToyFreddySuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafToyFreddySuitItem> MNAF_TOY_FREDDY_SUIT_LEGGINGS = REGISTRY.register("mnaf_toy_freddy_suit_leggings", () -> new MnafToyFreddySuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<MnafToyBonnieSuitItem> MNAF_TOY_BONNIE_SUIT_HELMET = REGISTRY.register("mnaf_toy_bonnie_suit_helmet", () -> new MnafToyBonnieSuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafToyBonnieSuitItem> MNAF_TOY_BONNIE_SUIT_CHESTPLATE = REGISTRY.register("mnaf_toy_bonnie_suit_chestplate", () -> new MnafToyBonnieSuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafToyBonnieSuitItem> MNAF_TOY_BONNIE_SUIT_LEGGINGS = REGISTRY.register("mnaf_toy_bonnie_suit_leggings", () -> new MnafToyBonnieSuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<MnafToyChicaSuitItem> MNAF_TOY_CHICA_SUIT_HELMET = REGISTRY.register("mnaf_toy_chica_suit_helmet", () -> new MnafToyChicaSuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafToyChicaSuitItem> MNAF_TOY_CHICA_SUIT_CHESTPLATE = REGISTRY.register("mnaf_toy_chica_suit_chestplate", () -> new MnafToyChicaSuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafToyChicaSuitItem> MNAF_TOY_CHICA_SUIT_LEGGINGS = REGISTRY.register("mnaf_toy_chica_suit_leggings", () -> new MnafToyChicaSuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<MnafBurntFreddySuitItem> MNAF_BURNT_FREDDY_SUIT_HELMET = REGISTRY.register("mnaf_burnt_freddy_suit_helmet", () -> new MnafBurntFreddySuitItem(ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<MnafBurntFreddySuitItem> MNAF_BURNT_FREDDY_SUIT_CHESTPLATE = REGISTRY.register("mnaf_burnt_freddy_suit_chestplate", () -> new MnafBurntFreddySuitItem(ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<MnafBurntFreddySuitItem> MNAF_BURNT_FREDDY_SUIT_LEGGINGS = REGISTRY.register("mnaf_burnt_freddy_suit_leggings", () -> new MnafBurntFreddySuitItem(ArmorItem.Type.LEGGINGS, new Item.Properties()));
	...
	public static final RegistryObject<Item> BLACK_WHITE_FOAM_TILES = block(YaFnafmodModBlocks.BLACK_WHITE_FOAM_TILES);
	public static final RegistryObject<Item> BLACK_WHITE_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.BLACK_WHITE_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> BLACK_WHITE_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.BLACK_WHITE_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> BLACK_WHITE_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.BLACK_WHITE_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> BLACK_RED_FOAM_TILES = block(YaFnafmodModBlocks.BLACK_RED_FOAM_TILES);
	public static final RegistryObject<Item> BLACK_RED_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.BLACK_RED_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> BLACK_RED_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.BLACK_RED_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> BLACK_RED_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.BLACK_RED_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> RED_WHITE_FOAM_TILES = block(YaFnafmodModBlocks.RED_WHITE_FOAM_TILES);
	public static final RegistryObject<Item> RED_WHITE_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.RED_WHITE_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> RED_WHITE_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.RED_WHITE_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> RED_WHITE_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.RED_WHITE_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> BLACK_BLUE_FOAM_TILES = block(YaFnafmodModBlocks.BLACK_BLUE_FOAM_TILES);
	public static final RegistryObject<Item> BLACK_BLUE_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.BLACK_BLUE_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> BLACK_BLUE_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.BLACK_BLUE_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> BLACK_BLUE_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.BLACK_BLUE_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> BLUE_WHITE_FOAM_TILES = block(YaFnafmodModBlocks.BLUE_WHITE_FOAM_TILES);
	public static final RegistryObject<Item> BLUE_WHITE_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.BLUE_WHITE_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> BLUE_WHITE_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.BLUE_WHITE_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> BLUE_WHITE_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.BLUE_WHITE_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> RED_BLUE_FOAM_TILES = block(YaFnafmodModBlocks.RED_BLUE_FOAM_TILES);
	public static final RegistryObject<Item> RED_BLUE_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.RED_BLUE_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> RED_BLUE_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.RED_BLUE_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> RED_BLUE_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.RED_BLUE_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> BLACK_GREEN_FOAM_TILES = block(YaFnafmodModBlocks.BLACK_GREEN_FOAM_TILES);
	public static final RegistryObject<Item> BLACK_GREEN_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.BLACK_GREEN_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> BLACK_GREEN_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.BLACK_GREEN_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> BLACK_GREEN_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.BLACK_GREEN_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> GREEN_WHITE_FOAM_TILES = block(YaFnafmodModBlocks.GREEN_WHITE_FOAM_TILES);
	public static final RegistryObject<Item> GREEN_WHITE_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.GREEN_WHITE_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> GREEN_WHITE_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.GREEN_WHITE_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> GREEN_WHITE_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.GREEN_WHITE_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> GREEN_LIME_FOAM_TILES = block(YaFnafmodModBlocks.GREEN_LIME_FOAM_TILES);
	public static final RegistryObject<Item> GREEN_LIME_FOAM_TILE_STAIRS = block(YaFnafmodModBlocks.GREEN_LIME_FOAM_TILE_STAIRS);
	public static final RegistryObject<Item> GREEN_LIME_FOAM_TILE_SLAB = block(YaFnafmodModBlocks.GREEN_LIME_FOAM_TILE_SLAB);
	public static final RegistryObject<Item> GREEN_LIME_FOAM_TILE_CARPET = block(YaFnafmodModBlocks.GREEN_LIME_FOAM_TILE_CARPET);
	public static final RegistryObject<Item> OLD_RED_WHITE_TILES = block(YaFnafmodModBlocks.OLD_RED_WHITE_TILES);
	public static final RegistryObject<Item> OLD_RED_WHITE_TILE_STAIRS = block(YaFnafmodModBlocks.OLD_RED_WHITE_TILE_STAIRS);
	public static final RegistryObject<Item> OLD_RED_WHITE_TILE_SLAB = block(YaFnafmodModBlocks.OLD_RED_WHITE_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_OLD_RED_WHITE_TILES = block(YaFnafmodModBlocks.CRACKED_OLD_RED_WHITE_TILES);
	public static final RegistryObject<Item> CRACKED_OLD_RED_WHITE_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_OLD_RED_WHITE_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_OLD_RED_WHITE_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_OLD_RED_WHITE_TILE_SLAB);
	public static final RegistryObject<Item> OLD_BLUE_WHITE_TILES = block(YaFnafmodModBlocks.OLD_BLUE_WHITE_TILES);
	public static final RegistryObject<Item> OLD_BLUE_WHITE_TILE_STAIRS = block(YaFnafmodModBlocks.OLD_BLUE_WHITE_TILE_STAIRS);
	public static final RegistryObject<Item> OLD_BLUE_WHITE_TILE_SLAB = block(YaFnafmodModBlocks.OLD_BLUE_WHITE_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_OLD_BLUE_WHITE_TILES = block(YaFnafmodModBlocks.CRACKED_OLD_BLUE_WHITE_TILES);
	public static final RegistryObject<Item> CRACKED_OLD_BLUE_WHITE_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_OLD_BLUE_WHITE_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_OLD_BLUE_WHITE_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_OLD_BLUE_WHITE_TILE_SLAB);
	public static final RegistryObject<Item> OLD_BLACK_GREEN_TILES = block(YaFnafmodModBlocks.OLD_BLACK_GREEN_TILES);
	public static final RegistryObject<Item> OLD_BLACK_GREEN_TILE_STAIRS = block(YaFnafmodModBlocks.OLD_BLACK_GREEN_TILE_STAIRS);
	public static final RegistryObject<Item> OLD_BLACK_GREEN_TILE_SLAB = block(YaFnafmodModBlocks.OLD_BLACK_GREEN_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_OLD_BLACK_GREEN_TILES = block(YaFnafmodModBlocks.CRACKED_OLD_BLACK_GREEN_TILES);
	public static final RegistryObject<Item> CRACKED_OLD_BLACK_GREEN_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_OLD_BLACK_GREEN_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_OLD_BLACK_GREEN_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_OLD_BLACK_GREEN_TILE_SLAB);
	public static final RegistryObject<Item> OLD_GREEN_WHITE_TILES = block(YaFnafmodModBlocks.OLD_GREEN_WHITE_TILES);
	public static final RegistryObject<Item> OLD_GREEN_WHITE_TILE_STAIRS = block(YaFnafmodModBlocks.OLD_GREEN_WHITE_TILE_STAIRS);
	public static final RegistryObject<Item> OLD_GREEN_WHITE_TILE_SLAB = block(YaFnafmodModBlocks.OLD_GREEN_WHITE_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_OLD_GREEN_WHITE_TILES = block(YaFnafmodModBlocks.CRACKED_OLD_GREEN_WHITE_TILES);
	public static final RegistryObject<Item> CRACKED_OLD_GREEN_WHITE_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_OLD_GREEN_WHITE_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_OLD_GREEN_WHITE_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_OLD_GREEN_WHITE_TILE_SLAB);
	public static final RegistryObject<Item> OLD_GREEN_LIME_TILES = block(YaFnafmodModBlocks.OLD_GREEN_LIME_TILES);
	public static final RegistryObject<Item> OLD_GREEN_LIME_TILE_STAIRS = block(YaFnafmodModBlocks.OLD_GREEN_LIME_TILE_STAIRS);
	public static final RegistryObject<Item> OLD_GREEN_LIME_TILE_SLAB = block(YaFnafmodModBlocks.OLD_GREEN_LIME_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_OLD_GREEN_LIME_TILES = block(YaFnafmodModBlocks.CRACKED_OLD_GREEN_LIME_TILES);
	public static final RegistryObject<Item> CRACKED_OLD_GREEN_LIME_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_OLD_GREEN_LIME_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_OLD_GREEN_LIME_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_OLD_GREEN_LIME_TILE_SLAB);
	...
	public static final RegistryObject<Item> FADED_GREEN_TILES = block(YaFnafmodModBlocks.FADED_GREEN_TILES);
	public static final RegistryObject<Item> FADED_GREEN_TILE_STAIRS = block(YaFnafmodModBlocks.FADED_GREEN_TILE_STAIRS);
	public static final RegistryObject<Item> FADED_GREEN_TILE_SLAB = block(YaFnafmodModBlocks.FADED_GREEN_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_FADED_GREEN_TILES = block(YaFnafmodModBlocks.CRACKED_FADED_GREEN_TILES);
	public static final RegistryObject<Item> CRACKED_FADED_GREEN_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_FADED_GREEN_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_FADED_GREEN_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_FADED_GREEN_TILE_SLAB);
	public static final RegistryObject<Item> FADED_BLACK_TILES = block(YaFnafmodModBlocks.FADED_BLACK_TILES);
	public static final RegistryObject<Item> FADED_BLACK_TILE_STAIRS = block(YaFnafmodModBlocks.FADED_BLACK_TILE_STAIRS);
	public static final RegistryObject<Item> FADED_BLACK_TILE_SLAB = block(YaFnafmodModBlocks.FADED_BLACK_TILE_SLAB);
	public static final RegistryObject<Item> CRACKED_FADED_BLACK_TILES = block(YaFnafmodModBlocks.CRACKED_FADED_BLACK_TILES);
	public static final RegistryObject<Item> CRACKED_FADED_BLACK_TILE_STAIRS = block(YaFnafmodModBlocks.CRACKED_FADED_BLACK_TILE_STAIRS);
	public static final RegistryObject<Item> CRACKED_FADED_BLACK_TILE_SLAB = block(YaFnafmodModBlocks.CRACKED_FADED_BLACK_TILE_SLAB);
