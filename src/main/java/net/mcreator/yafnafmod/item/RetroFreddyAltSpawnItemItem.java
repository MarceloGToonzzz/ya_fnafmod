...
public class RetroFreddyAltSpawnItemItem extends Item {
	public RetroFreddyAltSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.retro_freddy_alt_spawn_item.description_0"));
	}
