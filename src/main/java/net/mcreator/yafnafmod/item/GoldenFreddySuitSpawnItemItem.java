...
public class GoldenFreddySuitSpawnItemItem extends Item {
	public GoldenFreddySuitSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.golden_freddy_suit_spawn_item.description_0"));
	}
