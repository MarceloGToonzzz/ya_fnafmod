...
public class FredbearSuitSpawnItemItem extends Item {
	public FredbearSuitSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.fredbear_suit_spawn_item.description_0"));
	}
