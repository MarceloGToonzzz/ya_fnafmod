...
public class PitbonnieAltSpawnItemItem extends Item {
	public PitbonnieAltSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.pitbonnie_alt_spawn_item.description_0"));
	}
