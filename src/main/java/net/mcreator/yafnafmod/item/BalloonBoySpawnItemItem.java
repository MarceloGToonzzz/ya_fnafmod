...
public class BalloonBoySpawnItemItem extends Item {
	public BalloonBoySpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.balloon_boy_spawn_item.description_0"));
	}
