...
public class RetroFoxyWalkerSpawnItemItem extends Item {
	public RetroFoxyWalkerSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.retro_foxy_walker_spawn_item.description_0"));
	}
