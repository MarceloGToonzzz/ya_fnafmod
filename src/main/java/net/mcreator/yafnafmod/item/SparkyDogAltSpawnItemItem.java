...
public class SparkyDogAltSpawnItemItem extends Item {
	public SparkyDogAltSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.sparky_dog_alt_spawn_item.description_0"));
	}
