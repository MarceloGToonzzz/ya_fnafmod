...
public class RetroChicaWalkerSpawnItemItem extends Item {
	public RetroChicaWalkerSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7o(Also known as Unwithered/Prototype Chica!)"));
	}
