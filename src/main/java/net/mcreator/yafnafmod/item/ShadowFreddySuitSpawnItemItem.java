...
public class ShadowFreddySuitSpawnItemItem extends Item {
	public ShadowFreddySuitSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.shadow_freddy_suit_spawn_item.description_0"));
	}
