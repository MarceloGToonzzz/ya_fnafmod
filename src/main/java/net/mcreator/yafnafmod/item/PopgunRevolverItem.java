...
import net.mcreator.yafnafmod.item.renderer.PopgunRevolverItemRenderer;

import java.util.function.Consumer;

public class PopgunRevolverItem extends Item implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public PopgunRevolverItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new PopgunRevolverItemRenderer();
