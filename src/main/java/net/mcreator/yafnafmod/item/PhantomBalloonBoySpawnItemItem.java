...
public class PhantomBalloonBoySpawnItemItem extends Item {
	public PhantomBalloonBoySpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.phantom_balloon_boy_spawn_item.description_0"));
	}
