...
public class SpringlockEllaSuitSpawnItemItem extends Item {
	public SpringlockEllaSuitSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.springlock_ella_suit_spawn_item.description_0"));
	}
