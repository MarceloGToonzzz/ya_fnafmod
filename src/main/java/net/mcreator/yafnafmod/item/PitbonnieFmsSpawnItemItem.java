...
public class PitbonnieFmsSpawnItemItem extends Item {
	public PitbonnieFmsSpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.pitbonnie_fms_spawn_item.description_0"));
	}
