...
public class RetroFreddySpawnItemItem extends Item {
	public RetroFreddySpawnItemItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.ya_fnafmod.retro_freddy_spawn_item.description_0"));
	}
