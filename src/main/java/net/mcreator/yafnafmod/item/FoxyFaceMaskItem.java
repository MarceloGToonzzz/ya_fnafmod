...
import net.mcreator.yafnafmod.client.renderer.FoxyFaceMaskArmorRenderer;

import java.util.function.Consumer;
import java.util.List;

public class FoxyFaceMaskItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public FoxyFaceMaskItem(ArmorItem.Type type, Item.Properties properties) {
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new FoxyFaceMaskArmorRenderer();
