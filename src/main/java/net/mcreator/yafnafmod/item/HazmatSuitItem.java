...
public abstract class HazmatSuitItem extends ArmorItem {
	...
	public static class Chestplate extends HazmatSuitItem {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new Modelhazmat_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelhazmat_suit.LAYER_LOCATION)).BodyLayer, "left_arm",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "ya_fnafmod:textures/entities/hazmat_suit.png";
		}
	}
