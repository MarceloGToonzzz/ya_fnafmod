...
public class ClientListener {
	...
	public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerBlockEntityRenderer(YaFnafmodModBlockEntities.ARCADE_RACING_PINK.get(), context -> new ArcadeRacingPinkTileRenderer());
		event.registerBlockEntityRenderer(YaFnafmodModBlockEntities.ARCADE_RACING_BLUE.get(), context -> new ArcadeRacingBlueTileRenderer());
		event.registerBlockEntityRenderer(YaFnafmodModBlockEntities.TOY_FREDDY_HEAD.get(), context -> new ToyFreddyHeadTileRenderer());
		event.registerBlockEntityRenderer(YaFnafmodModBlockEntities.TOY_BONNIE_HEAD.get(), context -> new ToyBonnieHeadTileRenderer());
