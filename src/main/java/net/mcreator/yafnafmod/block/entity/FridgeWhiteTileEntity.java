...
public class FridgeWhiteTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public FridgeWhiteTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.FRIDGE_WHITE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FridgeWhiteBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FridgeWhiteTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FridgeWhiteTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fridge_white");
	}
