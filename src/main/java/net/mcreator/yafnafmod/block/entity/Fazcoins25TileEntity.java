...
public class Fazcoins25TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Fazcoins25TileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.FAZCOINS_25.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Fazcoins25Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Fazcoins25TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Fazcoins25TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fazcoins_25");
	}
	...
	public Component getDisplayName() {
		return Component.literal("25 Fazcoins");
	}
