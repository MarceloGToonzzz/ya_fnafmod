...
public class MusicManBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MusicManBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MusicManBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("music_man_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Music Man");
	}
