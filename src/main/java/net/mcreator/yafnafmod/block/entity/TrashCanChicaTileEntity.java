...
public class TrashCanChicaTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TrashCanChicaTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.TRASH_CAN_CHICA.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(TrashCanChicaBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TrashCanChicaTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TrashCanChicaTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("trash_can_chica");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Trash Can (Chica)");
	}
