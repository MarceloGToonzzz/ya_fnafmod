...
public class Bobbleheads3TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Bobbleheads3TileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BOBBLEHEADS_3.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Bobbleheads3Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Bobbleheads3TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Bobbleheads3TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("bobbleheads_3");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Bobbleheads (Fredbear's)");
	}
