...
public class TrashCanFoxyTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TrashCanFoxyTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.TRASH_CAN_FOXY.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(TrashCanFoxyBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<TrashCanFoxyTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<TrashCanFoxyTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("trash_can_foxy");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Trash Can (Foxy)");
	}
