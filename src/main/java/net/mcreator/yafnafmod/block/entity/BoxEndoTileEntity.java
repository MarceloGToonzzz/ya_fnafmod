...
public class BoxEndoTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BoxEndoTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BOX_ENDO.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BoxEndoBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BoxEndoTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BoxEndoTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("box_endo");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Open Box (Endo Parts)");
	}
