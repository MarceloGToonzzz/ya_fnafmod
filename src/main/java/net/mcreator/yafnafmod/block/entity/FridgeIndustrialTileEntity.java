...
public class FridgeIndustrialTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public FridgeIndustrialTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.FRIDGE_INDUSTRIAL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FridgeIndustrialBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FridgeIndustrialTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FridgeIndustrialTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fridge_industrial");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new FridgeIndustrialGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Industrial Fridge");
	}
