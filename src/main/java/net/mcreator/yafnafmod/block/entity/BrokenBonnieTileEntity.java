...
public class BrokenBonnieTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BrokenBonnieTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BrokenBonnieTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("broken_bonnie");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Broken Bonnie");
	}
