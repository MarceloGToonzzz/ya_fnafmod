...
public class BalloonCartTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BalloonCartTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BALLOON_CART.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BalloonCartBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BalloonCartTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BalloonCartTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("balloon_cart");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Balloon Cart");
	}
