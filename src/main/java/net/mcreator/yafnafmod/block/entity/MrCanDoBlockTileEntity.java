...
public class MrCanDoBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MrCanDoBlockTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.MR_CAN_DO_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(MrCanDoBlockBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MrCanDoBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MrCanDoBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("mr_can_do_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Mr Can Do");
	}
