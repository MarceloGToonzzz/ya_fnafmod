...
public class StageSunCreepTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public StageSunCreepTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.STAGE_SUN_CREEP.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(StageSunCreepBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<StageSunCreepTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<StageSunCreepTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("stage_sun_creep");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Creepy Stage Sun");
	}
