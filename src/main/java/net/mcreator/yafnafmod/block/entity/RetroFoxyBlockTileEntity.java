...
public class RetroFoxyBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RetroFoxyBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RetroFoxyBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("retro_foxy_block");
	}
