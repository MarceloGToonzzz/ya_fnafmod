...
public class PuppetBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PuppetBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PuppetBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("puppet_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Puppet");
	}
