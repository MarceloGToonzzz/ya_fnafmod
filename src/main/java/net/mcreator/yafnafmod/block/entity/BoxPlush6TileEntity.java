...
public class BoxPlush6TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BoxPlush6TileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BOX_PLUSH_6.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BoxPlush6Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BoxPlush6TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BoxPlush6TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("box_plush_6");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Open Box (Rockstar Plushies)");
	}
