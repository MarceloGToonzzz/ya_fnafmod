...
public class Fazcoins1000TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public Fazcoins1000TileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.FAZCOINS_1000.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(Fazcoins1000Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<Fazcoins1000TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<Fazcoins1000TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fazcoins_1000");
	}
	...
	public Component getDisplayName() {
		return Component.literal("1000 Fazcoins");
	}
