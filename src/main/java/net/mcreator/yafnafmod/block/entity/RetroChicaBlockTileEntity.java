...
public class RetroChicaBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RetroChicaBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RetroChicaBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("retro_chica_block");
	}
