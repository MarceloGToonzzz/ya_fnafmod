...
public class FridgeGrayTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public FridgeGrayTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.FRIDGE_GRAY.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FridgeGrayBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FridgeGrayTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FridgeGrayTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fridge_gray");
	}
