...
public class BallpitVintageTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BallpitVintageTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BALLPIT_VINTAGE.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BallpitVintageBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BallpitVintageTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BallpitVintageTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("ballpit_vintage");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Ballpit");
	}
