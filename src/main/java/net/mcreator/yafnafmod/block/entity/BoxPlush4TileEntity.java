...
public class BoxPlush4TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BoxPlush4TileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BOX_PLUSH_4.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BoxPlush4Block.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BoxPlush4TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BoxPlush4TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("box_plush_4");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Open Box (Golden Plushies)");
	}
