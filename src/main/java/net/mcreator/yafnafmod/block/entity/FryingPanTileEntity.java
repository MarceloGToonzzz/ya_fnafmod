...
public class FryingPanTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FryingPanTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.FRYING_PAN.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FryingPanBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FryingPanTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FryingPanTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
