...
public class BoxPlatesTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BoxPlatesTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BOX_PLATES.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BoxPlatesBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BoxPlatesTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BoxPlatesTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("box_plates");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Open Box (Colorful plates + Party Hats)");
	}
