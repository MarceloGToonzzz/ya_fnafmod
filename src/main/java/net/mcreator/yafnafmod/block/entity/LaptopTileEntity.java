...
public class LaptopTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LaptopTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.LAPTOP.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(LaptopBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<LaptopTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<LaptopTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
