...
public class PanStanBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PanStanBlockTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.PAN_STAN_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PanStanBlockBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PanStanBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PanStanBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("pan_stan_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Pan Stan");
	}
