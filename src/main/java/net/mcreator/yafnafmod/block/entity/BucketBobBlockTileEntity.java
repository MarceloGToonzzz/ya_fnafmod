...
public class BucketBobBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BucketBobBlockTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.BUCKET_BOB_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(BucketBobBlockBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BucketBobBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BucketBobBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("bucket_bob_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Bucket Bob");
	}
