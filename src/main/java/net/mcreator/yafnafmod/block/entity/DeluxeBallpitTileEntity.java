...
public class DeluxeBallpitTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public DeluxeBallpitTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.DELUXE_BALLPIT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(DeluxeBallpitBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DeluxeBallpitTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DeluxeBallpitTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("deluxe_ballpit");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Deluxe Ballpit");
	}
