...
public class PrizeKingTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PrizeKingTileEntity(BlockPos pos, BlockState state) {
		super(YaFnafmodModBlockEntities.PRIZE_KING.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(PrizeKingBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<PrizeKingTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<PrizeKingTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("prize_king");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Prize King");
	}
