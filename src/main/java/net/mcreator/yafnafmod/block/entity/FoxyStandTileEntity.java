...
public class FoxyStandTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FoxyStandTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FoxyStandTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("foxy_stand");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Foxy Stand");
	}
