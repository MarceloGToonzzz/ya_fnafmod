...
public class PizzaBox2023BlockModel extends GeoModel<PizzaBox2023TileEntity> {
	@Override
	public ResourceLocation getAnimationResource(PizzaBox2023TileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(PizzaBox2023TileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(PizzaBox2023TileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
