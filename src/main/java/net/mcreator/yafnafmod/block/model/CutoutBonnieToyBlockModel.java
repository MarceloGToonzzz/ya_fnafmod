...
public class CutoutBonnieToyBlockModel extends GeoModel<CutoutBonnieToyTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CutoutBonnieToyTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CutoutBonnieToyTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CutoutBonnieToyTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
