...
public class Endo02HeadBlockModel extends GeoModel<Endo02HeadTileEntity> {
	@Override
	...
	@Override
	public ResourceLocation getTextureResource(Endo02HeadTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
			return new ResourceLocation("ya_fnafmod", "textures/block/head_endo02-skin.png");
