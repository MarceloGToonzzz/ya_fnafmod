...
public class MusicBoxRedDecorationBlockModel extends GeoModel<MusicBoxRedDecorationTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(MusicBoxRedDecorationTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(MusicBoxRedDecorationTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(MusicBoxRedDecorationTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
