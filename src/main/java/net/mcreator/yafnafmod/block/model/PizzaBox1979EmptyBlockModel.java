...
public class PizzaBox1979EmptyBlockModel extends GeoModel<PizzaBox1979EmptyTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(PizzaBox1979EmptyTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(PizzaBox1979EmptyTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(PizzaBox1979EmptyTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
