...
public class CutoutPuppetBlockModel extends GeoModel<CutoutPuppetTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CutoutPuppetTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CutoutPuppetTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CutoutPuppetTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
