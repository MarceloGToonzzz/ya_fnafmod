...
public class CutoutTreePineBlockModel extends GeoModel<CutoutTreePineTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CutoutTreePineTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CutoutTreePineTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CutoutTreePineTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
