...
public class BigBedroomDoorBlockModel extends GeoModel<BigBedroomDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigBedroomDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigBedroomDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigBedroomDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
