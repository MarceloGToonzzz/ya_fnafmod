...
public class CutoutBalloonTwinsBlockModel extends GeoModel<CutoutBalloonTwinsTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CutoutBalloonTwinsTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CutoutBalloonTwinsTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CutoutBalloonTwinsTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
