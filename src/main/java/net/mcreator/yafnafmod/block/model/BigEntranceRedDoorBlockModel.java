...
public class BigEntranceRedDoorBlockModel extends GeoModel<BigEntranceRedDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigEntranceRedDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigEntranceRedDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigEntranceRedDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
