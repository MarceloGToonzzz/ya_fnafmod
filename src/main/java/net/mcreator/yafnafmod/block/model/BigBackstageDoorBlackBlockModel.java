...
public class BigBackstageDoorBlackBlockModel extends GeoModel<BigBackstageDoorBlackTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigBackstageDoorBlackTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigBackstageDoorBlackTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigBackstageDoorBlackTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
