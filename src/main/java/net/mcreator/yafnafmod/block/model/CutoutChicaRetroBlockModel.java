...
public class CutoutChicaRetroBlockModel extends GeoModel<CutoutChicaRetroTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CutoutChicaRetroTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CutoutChicaRetroTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CutoutChicaRetroTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
