...
public class Endo01HeadBlockModel extends GeoModel<Endo01HeadTileEntity> {
	@Override
	...
	@Override
	public ResourceLocation getTextureResource(Endo01HeadTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
			return new ResourceLocation("ya_fnafmod", "textures/block/head_endo01-skin.png");
