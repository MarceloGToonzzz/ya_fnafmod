...
public class CutoutChicaToyBlockModel extends GeoModel<CutoutChicaToyTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(CutoutChicaToyTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(CutoutChicaToyTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(CutoutChicaToyTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
