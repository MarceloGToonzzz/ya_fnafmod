...
public class FridgeIndustrialGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FridgeIndustrialGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(YaFnafmodModMenus.FRIDGE_INDUSTRIAL_GUI.get(), id);
