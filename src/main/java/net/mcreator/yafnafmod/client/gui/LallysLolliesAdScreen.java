...
public class LallysLolliesAdScreen extends AbstractContainerScreen<LallysLolliesAdMenu> {
	...
	public void init() {
		super.init();
		imagebutton_adskip = new ImageButton(this.leftPos + 6, this.topPos + 133, 45, 20, 0, 0, 20, new ResourceLocation("ya_fnafmod:textures/screens/atlas/imagebutton_adskip.png"), 45, 40, e -> {
			if (true) {
