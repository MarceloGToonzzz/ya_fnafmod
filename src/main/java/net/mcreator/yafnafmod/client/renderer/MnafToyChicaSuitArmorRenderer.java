...
import net.mcreator.yafnafmod.item.model.MnafToyChicaSuitModel;
import net.mcreator.yafnafmod.item.MnafToyChicaSuitItem;

public class MnafToyChicaSuitArmorRenderer extends GeoArmorRenderer<MnafToyChicaSuitItem> {
	public MnafToyChicaSuitArmorRenderer() {
		super(new MnafToyChicaSuitModel());
	...
	@Override
	public RenderType getRenderType(MnafToyChicaSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
