...
import net.mcreator.yafnafmod.item.model.MnafFredbearSuitModel;
import net.mcreator.yafnafmod.item.MnafFredbearSuitItem;

public class MnafFredbearSuitArmorRenderer extends GeoArmorRenderer<MnafFredbearSuitItem> {
	public MnafFredbearSuitArmorRenderer() {
		super(new MnafFredbearSuitModel());
	...
	@Override
	public RenderType getRenderType(MnafFredbearSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
