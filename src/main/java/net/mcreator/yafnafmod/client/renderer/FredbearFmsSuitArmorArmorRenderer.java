...
import net.mcreator.yafnafmod.item.model.FredbearFmsSuitArmorModel;
import net.mcreator.yafnafmod.item.FredbearFmsSuitArmorItem;

public class FredbearFmsSuitArmorArmorRenderer extends GeoArmorRenderer<FredbearFmsSuitArmorItem> {
	public FredbearFmsSuitArmorArmorRenderer() {
		super(new FredbearFmsSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(FredbearFmsSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
