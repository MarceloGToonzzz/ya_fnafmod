...
import net.mcreator.yafnafmod.item.model.SpringbonnieWitheredSuitArmorModel;
import net.mcreator.yafnafmod.item.SpringbonnieWitheredSuitArmorItem;

public class SpringbonnieWitheredSuitArmorArmorRenderer extends GeoArmorRenderer<SpringbonnieWitheredSuitArmorItem> {
	public SpringbonnieWitheredSuitArmorArmorRenderer() {
		super(new SpringbonnieWitheredSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(SpringbonnieWitheredSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
