...
import net.mcreator.yafnafmod.item.model.MnafShadowFreddySuitModel;
import net.mcreator.yafnafmod.item.MnafShadowFreddySuitItem;

public class MnafShadowFreddySuitArmorRenderer extends GeoArmorRenderer<MnafShadowFreddySuitItem> {
	public MnafShadowFreddySuitArmorRenderer() {
		super(new MnafShadowFreddySuitModel());
	...
	@Override
	public RenderType getRenderType(MnafShadowFreddySuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
