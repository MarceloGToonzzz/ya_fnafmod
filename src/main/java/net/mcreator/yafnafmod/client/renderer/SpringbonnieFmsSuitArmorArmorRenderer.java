...
import net.mcreator.yafnafmod.item.model.SpringbonnieFmsSuitArmorModel;
import net.mcreator.yafnafmod.item.SpringbonnieFmsSuitArmorItem;

public class SpringbonnieFmsSuitArmorArmorRenderer extends GeoArmorRenderer<SpringbonnieFmsSuitArmorItem> {
	public SpringbonnieFmsSuitArmorArmorRenderer() {
		super(new SpringbonnieFmsSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(SpringbonnieFmsSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
