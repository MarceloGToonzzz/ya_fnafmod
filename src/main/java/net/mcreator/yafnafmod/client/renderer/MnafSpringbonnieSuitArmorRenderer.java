...
import net.mcreator.yafnafmod.item.model.MnafSpringbonnieSuitModel;
import net.mcreator.yafnafmod.item.MnafSpringbonnieSuitItem;

public class MnafSpringbonnieSuitArmorRenderer extends GeoArmorRenderer<MnafSpringbonnieSuitItem> {
	public MnafSpringbonnieSuitArmorRenderer() {
		super(new MnafSpringbonnieSuitModel());
	...
	@Override
	public RenderType getRenderType(MnafSpringbonnieSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
