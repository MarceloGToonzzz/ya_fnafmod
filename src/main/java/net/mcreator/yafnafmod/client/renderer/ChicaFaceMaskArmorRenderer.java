...
import net.mcreator.yafnafmod.item.model.ChicaFaceMaskModel;
import net.mcreator.yafnafmod.item.ChicaFaceMaskItem;

public class ChicaFaceMaskArmorRenderer extends GeoArmorRenderer<ChicaFaceMaskItem> {
	public ChicaFaceMaskArmorRenderer() {
		super(new ChicaFaceMaskModel());
	...
	@Override
	public RenderType getRenderType(ChicaFaceMaskItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
