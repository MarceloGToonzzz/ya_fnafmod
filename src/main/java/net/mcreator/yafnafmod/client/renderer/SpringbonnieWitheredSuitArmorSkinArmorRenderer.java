...
import net.mcreator.yafnafmod.item.model.SpringbonnieWitheredSuitArmorSkinModel;
import net.mcreator.yafnafmod.item.SpringbonnieWitheredSuitArmorSkinItem;

public class SpringbonnieWitheredSuitArmorSkinArmorRenderer extends GeoArmorRenderer<SpringbonnieWitheredSuitArmorSkinItem> {
	public SpringbonnieWitheredSuitArmorSkinArmorRenderer() {
		super(new SpringbonnieWitheredSuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(SpringbonnieWitheredSuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
