...
import net.mcreator.yafnafmod.item.model.GlitchtrapSuitArmorModel;
import net.mcreator.yafnafmod.item.GlitchtrapSuitArmorItem;

public class GlitchtrapSuitArmorArmorRenderer extends GeoArmorRenderer<GlitchtrapSuitArmorItem> {
	public GlitchtrapSuitArmorArmorRenderer() {
		super(new GlitchtrapSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(GlitchtrapSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
