...
import net.mcreator.yafnafmod.item.model.FoxyFaceMaskModel;
import net.mcreator.yafnafmod.item.FoxyFaceMaskItem;

public class FoxyFaceMaskArmorRenderer extends GeoArmorRenderer<FoxyFaceMaskItem> {
	public FoxyFaceMaskArmorRenderer() {
		super(new FoxyFaceMaskModel());
	...
	@Override
	public RenderType getRenderType(FoxyFaceMaskItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
