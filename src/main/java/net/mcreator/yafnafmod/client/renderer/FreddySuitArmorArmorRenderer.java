...
import net.mcreator.yafnafmod.item.model.FreddySuitArmorModel;
import net.mcreator.yafnafmod.item.FreddySuitArmorItem;

public class FreddySuitArmorArmorRenderer extends GeoArmorRenderer<FreddySuitArmorItem> {
	public FreddySuitArmorArmorRenderer() {
		super(new FreddySuitArmorModel());
	...
	@Override
	public RenderType getRenderType(FreddySuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
