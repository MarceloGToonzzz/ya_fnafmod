...
import net.mcreator.yafnafmod.item.model.YellowRabbitSuitArmorModel;
import net.mcreator.yafnafmod.item.YellowRabbitSuitArmorItem;

public class YellowRabbitSuitArmorArmorRenderer extends GeoArmorRenderer<YellowRabbitSuitArmorItem> {
	public YellowRabbitSuitArmorArmorRenderer() {
		super(new YellowRabbitSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(YellowRabbitSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
