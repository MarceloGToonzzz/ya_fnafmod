...
public class MysteriousGiantScuttlerRenderer extends GeoEntityRenderer<MysteriousGiantScuttlerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, MysteriousGiantScuttlerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
