...
import net.mcreator.yafnafmod.item.model.YellowRabbitFixedSuitArmorModel;
import net.mcreator.yafnafmod.item.YellowRabbitFixedSuitArmorItem;

public class YellowRabbitFixedSuitArmorArmorRenderer extends GeoArmorRenderer<YellowRabbitFixedSuitArmorItem> {
	public YellowRabbitFixedSuitArmorArmorRenderer() {
		super(new YellowRabbitFixedSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(YellowRabbitFixedSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
