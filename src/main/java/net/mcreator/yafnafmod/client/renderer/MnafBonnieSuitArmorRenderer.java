...
import net.mcreator.yafnafmod.item.model.MnafBonnieSuitModel;
import net.mcreator.yafnafmod.item.MnafBonnieSuitItem;

public class MnafBonnieSuitArmorRenderer extends GeoArmorRenderer<MnafBonnieSuitItem> {
	public MnafBonnieSuitArmorRenderer() {
		super(new MnafBonnieSuitModel());
	...
	@Override
	public RenderType getRenderType(MnafBonnieSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
