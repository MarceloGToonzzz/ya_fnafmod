...
import net.mcreator.yafnafmod.item.model.FreddySuitArmorSkinModel;
import net.mcreator.yafnafmod.item.FreddySuitArmorSkinItem;

public class FreddySuitArmorSkinArmorRenderer extends GeoArmorRenderer<FreddySuitArmorSkinItem> {
	public FreddySuitArmorSkinArmorRenderer() {
		super(new FreddySuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(FreddySuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
