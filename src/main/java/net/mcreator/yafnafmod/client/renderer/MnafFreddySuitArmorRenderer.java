...
import net.mcreator.yafnafmod.item.model.MnafFreddySuitModel;
import net.mcreator.yafnafmod.item.MnafFreddySuitItem;

public class MnafFreddySuitArmorRenderer extends GeoArmorRenderer<MnafFreddySuitItem> {
	public MnafFreddySuitArmorRenderer() {
		super(new MnafFreddySuitModel());
	...
	@Override
	public RenderType getRenderType(MnafFreddySuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
