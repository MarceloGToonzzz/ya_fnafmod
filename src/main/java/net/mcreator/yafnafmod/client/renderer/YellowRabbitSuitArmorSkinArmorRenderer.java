...
import net.mcreator.yafnafmod.item.model.YellowRabbitSuitArmorSkinModel;
import net.mcreator.yafnafmod.item.YellowRabbitSuitArmorSkinItem;

public class YellowRabbitSuitArmorSkinArmorRenderer extends GeoArmorRenderer<YellowRabbitSuitArmorSkinItem> {
	public YellowRabbitSuitArmorSkinArmorRenderer() {
		super(new YellowRabbitSuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(YellowRabbitSuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
