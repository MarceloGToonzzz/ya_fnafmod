...
import net.mcreator.yafnafmod.item.model.BonnieFaceMaskModel;
import net.mcreator.yafnafmod.item.BonnieFaceMaskItem;

public class BonnieFaceMaskArmorRenderer extends GeoArmorRenderer<BonnieFaceMaskItem> {
	public BonnieFaceMaskArmorRenderer() {
		super(new BonnieFaceMaskModel());
	...
	@Override
	public RenderType getRenderType(BonnieFaceMaskItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
