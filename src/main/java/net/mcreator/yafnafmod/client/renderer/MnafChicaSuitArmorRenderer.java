...
import net.mcreator.yafnafmod.item.model.MnafChicaSuitModel;
import net.mcreator.yafnafmod.item.MnafChicaSuitItem;

public class MnafChicaSuitArmorRenderer extends GeoArmorRenderer<MnafChicaSuitItem> {
	public MnafChicaSuitArmorRenderer() {
		super(new MnafChicaSuitModel());
	...
	@Override
	public RenderType getRenderType(MnafChicaSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
