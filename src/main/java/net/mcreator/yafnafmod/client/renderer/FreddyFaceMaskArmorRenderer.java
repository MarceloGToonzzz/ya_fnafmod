...
import net.mcreator.yafnafmod.item.model.FreddyFaceMaskModel;
import net.mcreator.yafnafmod.item.FreddyFaceMaskItem;

public class FreddyFaceMaskArmorRenderer extends GeoArmorRenderer<FreddyFaceMaskItem> {
	public FreddyFaceMaskArmorRenderer() {
		super(new FreddyFaceMaskModel());
	...
	@Override
	public RenderType getRenderType(FreddyFaceMaskItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
