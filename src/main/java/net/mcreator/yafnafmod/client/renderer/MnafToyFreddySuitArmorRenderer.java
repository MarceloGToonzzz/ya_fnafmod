...
import net.mcreator.yafnafmod.item.model.MnafToyFreddySuitModel;
import net.mcreator.yafnafmod.item.MnafToyFreddySuitItem;

public class MnafToyFreddySuitArmorRenderer extends GeoArmorRenderer<MnafToyFreddySuitItem> {
	public MnafToyFreddySuitArmorRenderer() {
		super(new MnafToyFreddySuitModel());
	...
	@Override
	public RenderType getRenderType(MnafToyFreddySuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
