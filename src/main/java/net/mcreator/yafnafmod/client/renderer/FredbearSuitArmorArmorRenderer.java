...
import net.mcreator.yafnafmod.item.model.FredbearSuitArmorModel;
import net.mcreator.yafnafmod.item.FredbearSuitArmorItem;

public class FredbearSuitArmorArmorRenderer extends GeoArmorRenderer<FredbearSuitArmorItem> {
	public FredbearSuitArmorArmorRenderer() {
		super(new FredbearSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(FredbearSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
