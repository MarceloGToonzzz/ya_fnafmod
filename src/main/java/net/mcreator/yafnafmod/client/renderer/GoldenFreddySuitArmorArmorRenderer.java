...
import net.mcreator.yafnafmod.item.model.GoldenFreddySuitArmorModel;
import net.mcreator.yafnafmod.item.GoldenFreddySuitArmorItem;

public class GoldenFreddySuitArmorArmorRenderer extends GeoArmorRenderer<GoldenFreddySuitArmorItem> {
	public GoldenFreddySuitArmorArmorRenderer() {
		super(new GoldenFreddySuitArmorModel());
	...
	@Override
	public RenderType getRenderType(GoldenFreddySuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
