...
import net.mcreator.yafnafmod.item.model.SpringbonnieSuitArmorSkinModel;
import net.mcreator.yafnafmod.item.SpringbonnieSuitArmorSkinItem;

public class SpringbonnieSuitArmorSkinArmorRenderer extends GeoArmorRenderer<SpringbonnieSuitArmorSkinItem> {
	public SpringbonnieSuitArmorSkinArmorRenderer() {
		super(new SpringbonnieSuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(SpringbonnieSuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
