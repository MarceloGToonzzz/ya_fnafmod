...
import net.mcreator.yafnafmod.item.model.VrHeadsetToyFreddyModel;
import net.mcreator.yafnafmod.item.VrHeadsetToyFreddyItem;

public class VrHeadsetToyFreddyArmorRenderer extends GeoArmorRenderer<VrHeadsetToyFreddyItem> {
	public VrHeadsetToyFreddyArmorRenderer() {
		super(new VrHeadsetToyFreddyModel());
	...
	@Override
	public RenderType getRenderType(VrHeadsetToyFreddyItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
