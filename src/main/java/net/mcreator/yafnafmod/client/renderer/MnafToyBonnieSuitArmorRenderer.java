...
import net.mcreator.yafnafmod.item.model.MnafToyBonnieSuitModel;
import net.mcreator.yafnafmod.item.MnafToyBonnieSuitItem;

public class MnafToyBonnieSuitArmorRenderer extends GeoArmorRenderer<MnafToyBonnieSuitItem> {
	public MnafToyBonnieSuitArmorRenderer() {
		super(new MnafToyBonnieSuitModel());
	...
	@Override
	public RenderType getRenderType(MnafToyBonnieSuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
