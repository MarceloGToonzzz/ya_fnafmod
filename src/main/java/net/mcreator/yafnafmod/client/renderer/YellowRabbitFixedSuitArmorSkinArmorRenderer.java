...
import net.mcreator.yafnafmod.item.model.YellowRabbitFixedSuitArmorSkinModel;
import net.mcreator.yafnafmod.item.YellowRabbitFixedSuitArmorSkinItem;

public class YellowRabbitFixedSuitArmorSkinArmorRenderer extends GeoArmorRenderer<YellowRabbitFixedSuitArmorSkinItem> {
	public YellowRabbitFixedSuitArmorSkinArmorRenderer() {
		super(new YellowRabbitFixedSuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(YellowRabbitFixedSuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
