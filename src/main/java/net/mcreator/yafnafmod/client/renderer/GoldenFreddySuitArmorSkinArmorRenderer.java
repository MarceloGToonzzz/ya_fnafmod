...
import net.mcreator.yafnafmod.item.model.GoldenFreddySuitArmorSkinModel;
import net.mcreator.yafnafmod.item.GoldenFreddySuitArmorSkinItem;

public class GoldenFreddySuitArmorSkinArmorRenderer extends GeoArmorRenderer<GoldenFreddySuitArmorSkinItem> {
	public GoldenFreddySuitArmorSkinArmorRenderer() {
		super(new GoldenFreddySuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(GoldenFreddySuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
