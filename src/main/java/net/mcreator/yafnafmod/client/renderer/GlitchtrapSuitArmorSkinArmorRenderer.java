...
import net.mcreator.yafnafmod.item.model.GlitchtrapSuitArmorSkinModel;
import net.mcreator.yafnafmod.item.GlitchtrapSuitArmorSkinItem;

public class GlitchtrapSuitArmorSkinArmorRenderer extends GeoArmorRenderer<GlitchtrapSuitArmorSkinItem> {
	public GlitchtrapSuitArmorSkinArmorRenderer() {
		super(new GlitchtrapSuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(GlitchtrapSuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
