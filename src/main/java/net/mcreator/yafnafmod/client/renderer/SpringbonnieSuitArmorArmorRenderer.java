...
import net.mcreator.yafnafmod.item.model.SpringbonnieSuitArmorModel;
import net.mcreator.yafnafmod.item.SpringbonnieSuitArmorItem;

public class SpringbonnieSuitArmorArmorRenderer extends GeoArmorRenderer<SpringbonnieSuitArmorItem> {
	public SpringbonnieSuitArmorArmorRenderer() {
		super(new SpringbonnieSuitArmorModel());
	...
	@Override
	public RenderType getRenderType(SpringbonnieSuitArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
