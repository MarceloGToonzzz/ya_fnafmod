...
import net.mcreator.yafnafmod.item.model.MnafFoxySuitModel;
import net.mcreator.yafnafmod.item.MnafFoxySuitItem;

public class MnafFoxySuitArmorRenderer extends GeoArmorRenderer<MnafFoxySuitItem> {
	public MnafFoxySuitArmorRenderer() {
		super(new MnafFoxySuitModel());
	...
	@Override
	public RenderType getRenderType(MnafFoxySuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
