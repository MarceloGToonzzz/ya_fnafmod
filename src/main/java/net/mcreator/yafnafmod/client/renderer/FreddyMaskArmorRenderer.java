...
import net.mcreator.yafnafmod.item.model.FreddyMaskModel;
import net.mcreator.yafnafmod.item.FreddyMaskItem;

public class FreddyMaskArmorRenderer extends GeoArmorRenderer<FreddyMaskItem> {
	public FreddyMaskArmorRenderer() {
		super(new FreddyMaskModel());
	...
	@Override
	public RenderType getRenderType(FreddyMaskItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
