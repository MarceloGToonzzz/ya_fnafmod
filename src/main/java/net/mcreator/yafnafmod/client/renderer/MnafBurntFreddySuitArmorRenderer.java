...
import net.mcreator.yafnafmod.item.model.MnafBurntFreddySuitModel;
import net.mcreator.yafnafmod.item.MnafBurntFreddySuitItem;

public class MnafBurntFreddySuitArmorRenderer extends GeoArmorRenderer<MnafBurntFreddySuitItem> {
	public MnafBurntFreddySuitArmorRenderer() {
		super(new MnafBurntFreddySuitModel());
	...
	@Override
	public RenderType getRenderType(MnafBurntFreddySuitItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
