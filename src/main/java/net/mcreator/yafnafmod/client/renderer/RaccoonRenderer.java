...
public class RaccoonRenderer extends GeoEntityRenderer<RaccoonEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RaccoonEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
