...
import net.mcreator.yafnafmod.item.model.FredbearSuitArmorSkinModel;
import net.mcreator.yafnafmod.item.FredbearSuitArmorSkinItem;

public class FredbearSuitArmorSkinArmorRenderer extends GeoArmorRenderer<FredbearSuitArmorSkinItem> {
	public FredbearSuitArmorSkinArmorRenderer() {
		super(new FredbearSuitArmorSkinModel());
	...
	@Override
	public RenderType getRenderType(FredbearSuitArmorSkinItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
