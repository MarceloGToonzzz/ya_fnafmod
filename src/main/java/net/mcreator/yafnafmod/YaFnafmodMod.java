...
@Mod("ya_fnafmod")
public class YaFnafmodMod {
	public static final Logger LOGGER = LogManager.getLogger(YaFnafmodMod.class);
	public static final String MODID = "ya_fnafmod";
	...
	public YaFnafmodMod() {
		...
		YaFnafmodModSounds.REGISTRY.register(bus);
		YaFnafmodModBlocks.REGISTRY.register(bus);
		YaFnafmodModBlockEntities.REGISTRY.register(bus);
		YaFnafmodModItems.REGISTRY.register(bus);
