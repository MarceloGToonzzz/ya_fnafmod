					...
					if (40 > entity.getPersistentData().getDouble("attackvoice_tick")) {
						if (entity.getPersistentData().getBoolean("said_attack_line") == false) {
							...
							if (entity instanceof YellowRabbitEntity) {
								...
								if (world instanceof Level)
									((Level) world).playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ya_fnafmod:anima_glitchtrap_voice_hostile")), SoundSource.HOSTILE, 1, 1);
							} else if (entity instanceof PlushbabyMobEntity) {
								if (world instanceof Level)
									((Level) world).playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ya_fnafmod:anima_plushbaby_voice_hostile")), SoundSource.HOSTILE, 1, 1);
							}
