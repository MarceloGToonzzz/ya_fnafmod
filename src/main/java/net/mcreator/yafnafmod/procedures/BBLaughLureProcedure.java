...
public class BBLaughLureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof BalloonBoyEntity _datEntL0 && _datEntL0.getEntityData().get(BalloonBoyEntity.DATA_can_laugh)) == true || (entity instanceof JJEntity _datEntL1 && _datEntL1.getEntityData().get(JJEntity.DATA_can_laugh)) == true
				|| (entity instanceof MemoryChicaEntity _datEntL2 && _datEntL2.getEntityData().get(MemoryChicaEntity.DATA_can_lure)) == true) {
			...
			if (entity instanceof MemoryChicaEntity _datEntSetL)
				_datEntSetL.getEntityData().set(MemoryChicaEntity.DATA_luring, true);
			if (entity instanceof BalloonBoyEntity _datEntSetL)
			...
			if (entity instanceof MemoryChicaEntity _datEntSetL)
				_datEntSetL.getEntityData().set(MemoryChicaEntity.DATA_can_lure, false);
			if (!(entity instanceof MemoryChicaEntity)) {
				...
				if (world instanceof Level)
					((Level) world).playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ya_fnafmod:anim_memorychica_lure")), SoundSource.HOSTILE, 2, 1);
				YaFnafmodMod.queueServerWork(260, () -> {
					if (entity instanceof MemoryChicaEntity _datEntSetL)
						_datEntSetL.getEntityData().set(MemoryChicaEntity.DATA_can_lure, true);
				});
			}
		}
	}
