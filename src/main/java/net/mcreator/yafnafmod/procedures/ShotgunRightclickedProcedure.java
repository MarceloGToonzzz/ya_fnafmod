...
public class ShotgunRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (!(entity instanceof Player _plrCldCheck6 && _plrCldCheck6.getCooldowns().isOnCooldown(itemstack.getItem()))) {
			...
			}.checkGamemode(entity) || (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(YaFnafmodModItems.SHOTGUN_SHELL.get())) : false)) {
