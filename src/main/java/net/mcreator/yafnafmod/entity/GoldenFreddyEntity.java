...
public class GoldenFreddyEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<Boolean> DATA_started_mumbling = SynchedEntityData.defineId(GoldenFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public GoldenFreddyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.GOLDEN_FREDDY.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "gfreddy");
		this.entityData.define(DATA_started_mumbling, false);
	}
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		compound.putBoolean("Datastarted_mumbling", this.entityData.get(DATA_started_mumbling));
	}
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("Datastarted_mumbling"))
			this.entityData.set(DATA_started_mumbling, compound.getBoolean("Datastarted_mumbling"));
	}
