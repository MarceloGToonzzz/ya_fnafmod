...
public class DougDogEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DougDogEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DougDogEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DougDogEntity.class, EntityDataSerializers.STRING);
	...
	public DougDogEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.DOUG_DOG.get(), world);
	}

	public DougDogEntity(EntityType<DougDogEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "doug");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RandomLookAroundGoal(this) {
			...
			public boolean canUse() {
				double x = DougDogEntity.this.getX();
				double y = DougDogEntity.this.getY();
				double z = DougDogEntity.this.getZ();
				Entity entity = DougDogEntity.this;
				Level world = DougDogEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DougDogEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
