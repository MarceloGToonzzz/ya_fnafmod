...
public class ElectrobabEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ElectrobabEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ElectrobabEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ElectrobabEntity.class, EntityDataSerializers.STRING);
	...
	public ElectrobabEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.ELECTROBAB.get(), world);
	}

	public ElectrobabEntity(EntityType<ElectrobabEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ElectrobabEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
