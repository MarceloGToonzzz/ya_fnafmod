...
public class RustyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RustyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RustyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RustyEntity.class, EntityDataSerializers.STRING);
	...
	public RustyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.RUSTY.get(), world);
	}

	public RustyEntity(EntityType<RustyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "endo1_rusty");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RandomLookAroundGoal(this) {
			...
			public boolean canUse() {
				double x = RustyEntity.this.getX();
				double y = RustyEntity.this.getY();
				double z = RustyEntity.this.getZ();
				Entity entity = RustyEntity.this;
				Level world = RustyEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RustyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
