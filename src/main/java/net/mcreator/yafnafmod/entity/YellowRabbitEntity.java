...
public class YellowRabbitEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YellowRabbitEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YellowRabbitEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YellowRabbitEntity.class, EntityDataSerializers.STRING);
	...
	public YellowRabbitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.YELLOW_RABBIT.get(), world);
	}

	public YellowRabbitEntity(EntityType<YellowRabbitEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "yellow_rabbit");
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, ChildEntity.class, true, false) {
			...
			public boolean canUse() {
				...
				double y = YellowRabbitEntity.this.getY();
				double z = YellowRabbitEntity.this.getZ();
				Entity entity = YellowRabbitEntity.this;
				Level world = YellowRabbitEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YellowRabbitEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
