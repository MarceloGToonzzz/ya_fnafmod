...
public class ElChipEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ElChipEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ElChipEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ElChipEntity.class, EntityDataSerializers.STRING);
	...
	public ElChipEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.EL_CHIP.get(), world);
	}

	public ElChipEntity(EntityType<ElChipEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ElChipEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
