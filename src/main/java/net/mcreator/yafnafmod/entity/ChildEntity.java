...
public class ChildEntity extends PathfinderMob implements GeoEntity {
	...
	public static final EntityDataAccessor<String> DATA_emotion = SynchedEntityData.defineId(ChildEntity.class, EntityDataSerializers.STRING);
	...
	public ChildEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.CHILD.get(), world);
	}

	public ChildEntity(EntityType<ChildEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(DATA_emotion, "happy");
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		ChildEntityIsHurtProcedure.execute(this, source.getEntity());
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		compound.putString("Dataemotion", this.entityData.get(DATA_emotion));
	}
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("Dataemotion"))
			this.entityData.set(DATA_emotion, compound.getString("Dataemotion"));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ChildRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ChildOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ChildEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
