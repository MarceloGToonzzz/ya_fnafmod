...
public class ScraptrapEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ScraptrapEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ScraptrapEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ScraptrapEntity.class, EntityDataSerializers.STRING);
	...
	public ScraptrapEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.SCRAPTRAP.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "scraptrap");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ScraptrapEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
