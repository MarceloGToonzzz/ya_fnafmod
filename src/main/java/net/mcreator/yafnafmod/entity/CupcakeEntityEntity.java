...
public class CupcakeEntityEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(CupcakeEntityEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(CupcakeEntityEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(CupcakeEntityEntity.class, EntityDataSerializers.STRING);
	...
	public CupcakeEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.CUPCAKE_ENTITY.get(), world);
	}

	public CupcakeEntityEntity(EntityType<CupcakeEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "cupcake");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CupcakeEntityEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
