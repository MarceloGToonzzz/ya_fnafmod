...
public class RockstarBonnieEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RockstarBonnieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RockstarBonnieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RockstarBonnieEntity.class, EntityDataSerializers.STRING);
	...
	public RockstarBonnieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.ROCKSTAR_BONNIE.get(), world);
	}

	public RockstarBonnieEntity(EntityType<RockstarBonnieEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RockstarBonnieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
