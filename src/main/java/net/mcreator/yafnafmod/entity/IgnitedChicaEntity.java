...
public class IgnitedChicaEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(IgnitedChicaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(IgnitedChicaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(IgnitedChicaEntity.class, EntityDataSerializers.STRING);
	...
	public IgnitedChicaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.IGNITED_CHICA.get(), world);
	}

	public IgnitedChicaEntity(EntityType<IgnitedChicaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(IgnitedChicaEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
