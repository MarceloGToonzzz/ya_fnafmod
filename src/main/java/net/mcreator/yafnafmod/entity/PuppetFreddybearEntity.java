...
public class PuppetFreddybearEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PuppetFreddybearEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PuppetFreddybearEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PuppetFreddybearEntity.class, EntityDataSerializers.STRING);
	...
	public PuppetFreddybearEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.PUPPET_FREDDYBEAR.get(), world);
	}

	public PuppetFreddybearEntity(EntityType<PuppetFreddybearEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "graveyardshift_freddybear");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(8, new RandomLookAroundGoal(this) {
			...
			public boolean canUse() {
				double x = PuppetFreddybearEntity.this.getX();
				double y = PuppetFreddybearEntity.this.getY();
				double z = PuppetFreddybearEntity.this.getZ();
				Entity entity = PuppetFreddybearEntity.this;
				Level world = PuppetFreddybearEntity.this.level();
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ya_fnafmod:anim_gsaf_freddybear_laugh"));
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PuppetFreddybearEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
