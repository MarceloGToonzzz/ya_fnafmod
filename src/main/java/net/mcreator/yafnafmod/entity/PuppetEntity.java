...
public class PuppetEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<Boolean> DATA_busy = SynchedEntityData.defineId(PuppetEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public PuppetEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.PUPPET.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "puppet_night");
