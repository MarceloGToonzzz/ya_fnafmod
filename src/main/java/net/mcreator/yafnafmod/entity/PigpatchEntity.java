...
public class PigpatchEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PigpatchEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PigpatchEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PigpatchEntity.class, EntityDataSerializers.STRING);
	...
	public PigpatchEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.PIGPATCH.get(), world);
	}

	public PigpatchEntity(EntityType<PigpatchEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RandomLookAroundGoal(this) {
			...
			public boolean canUse() {
				double x = PigpatchEntity.this.getX();
				double y = PigpatchEntity.this.getY();
				double z = PigpatchEntity.this.getZ();
				Entity entity = PigpatchEntity.this;
				Level world = PigpatchEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PigpatchEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
