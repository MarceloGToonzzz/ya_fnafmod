...
public class CircusBabyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(CircusBabyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(CircusBabyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(CircusBabyEntity.class, EntityDataSerializers.STRING);
	...
	public CircusBabyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.CIRCUS_BABY.get(), world);
	}

	public CircusBabyEntity(EntityType<CircusBabyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CircusBabyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
