...
public class BonnetEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BonnetEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BonnetEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BonnetEntity.class, EntityDataSerializers.STRING);
	...
	public BonnetEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.BONNET.get(), world);
	}

	public BonnetEntity(EntityType<BonnetEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BonnetEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
