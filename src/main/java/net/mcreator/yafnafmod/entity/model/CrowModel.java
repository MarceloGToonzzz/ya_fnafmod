...
public class CrowModel extends GeoModel<CrowEntity> {
	...
	public ResourceLocation getAnimationResource(CrowEntity entity) {
		return new ResourceLocation("ya_fnafmod", "animations/crow.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(CrowEntity entity) {
		return new ResourceLocation("ya_fnafmod", "geo/crow.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(CrowEntity animatable, long instanceId, AnimationState animationState) {
