...
public class DougDogModel extends GeoModel<DougDogEntity> {
	...
	@Override
	public ResourceLocation getTextureResource(DougDogEntity entity) {
		return new ResourceLocation("ya_fnafmod", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(DougDogEntity animatable, long instanceId, AnimationState animationState) {
