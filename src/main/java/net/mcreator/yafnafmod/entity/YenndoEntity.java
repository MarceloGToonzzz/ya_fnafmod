...
public class YenndoEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YenndoEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YenndoEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YenndoEntity.class, EntityDataSerializers.STRING);
	...
	public YenndoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.YENNDO.get(), world);
	}

	public YenndoEntity(EntityType<YenndoEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "yenndo");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new RandomLookAroundGoal(this) {
			...
			public boolean canUse() {
				double x = YenndoEntity.this.getX();
				double y = YenndoEntity.this.getY();
				double z = YenndoEntity.this.getZ();
				Entity entity = YenndoEntity.this;
				Level world = YenndoEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YenndoEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
