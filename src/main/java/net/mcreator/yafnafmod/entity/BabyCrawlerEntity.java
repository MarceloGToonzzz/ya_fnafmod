...
public class BabyCrawlerEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BabyCrawlerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BabyCrawlerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BabyCrawlerEntity.class, EntityDataSerializers.STRING);
	...
	public BabyCrawlerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.BABY_CRAWLER.get(), world);
	}

	public BabyCrawlerEntity(EntityType<BabyCrawlerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BabyCrawlerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
