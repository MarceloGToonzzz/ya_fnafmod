...
public class CrowEntity extends TamableAnimal implements GeoEntity {
	...
	public CrowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.CROW.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CrowEntity retval = YaFnafmodModEntities.CROW.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(YaFnafmodModEntities.CROW.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
