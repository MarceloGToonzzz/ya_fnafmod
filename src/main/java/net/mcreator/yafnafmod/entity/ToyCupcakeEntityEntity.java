...
public class ToyCupcakeEntityEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ToyCupcakeEntityEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ToyCupcakeEntityEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ToyCupcakeEntityEntity.class, EntityDataSerializers.STRING);
	...
	public ToyCupcakeEntityEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.TOY_CUPCAKE_ENTITY.get(), world);
	}

	public ToyCupcakeEntityEntity(EntityType<ToyCupcakeEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "cupcake_toy");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ToyCupcakeEntityEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
