...
public class OrvilleElephantEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(OrvilleElephantEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(OrvilleElephantEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(OrvilleElephantEntity.class, EntityDataSerializers.STRING);
	...
	public OrvilleElephantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.ORVILLE_ELEPHANT.get(), world);
	}

	public OrvilleElephantEntity(EntityType<OrvilleElephantEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RandomLookAroundGoal(this) {
			...
			public boolean canUse() {
				double x = OrvilleElephantEntity.this.getX();
				double y = OrvilleElephantEntity.this.getY();
				double z = OrvilleElephantEntity.this.getZ();
				Entity entity = OrvilleElephantEntity.this;
				Level world = OrvilleElephantEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(OrvilleElephantEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
