...
public class MusicManEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MusicManEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MusicManEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MusicManEntity.class, EntityDataSerializers.STRING);
	...
	public MusicManEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.MUSIC_MAN.get(), world);
	}

	public MusicManEntity(EntityType<MusicManEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MusicManEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
