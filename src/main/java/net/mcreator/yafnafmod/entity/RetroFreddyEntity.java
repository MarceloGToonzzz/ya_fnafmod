...
public class RetroFreddyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RetroFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RetroFreddyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RetroFreddyEntity.class, EntityDataSerializers.STRING);
	...
	public RetroFreddyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.RETRO_FREDDY.get(), world);
	}

	public RetroFreddyEntity(EntityType<RetroFreddyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RetroFreddyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
