...
public class BalloonBoyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BalloonBoyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BalloonBoyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BalloonBoyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Boolean> DATA_can_laugh = SynchedEntityData.defineId(BalloonBoyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Boolean> DATA_laughing = SynchedEntityData.defineId(BalloonBoyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<Integer> DATA_laugh_tick = SynchedEntityData.defineId(BalloonBoyEntity.class, EntityDataSerializers.INT);
	...
	public BalloonBoyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YaFnafmodModEntities.BALLOON_BOY.get(), world);
	}

	public BalloonBoyEntity(EntityType<BalloonBoyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.bb.idle_bb"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BalloonBoyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
