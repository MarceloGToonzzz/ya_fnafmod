...
import net.mcreator.yafnafmod.procedures.TestOnKeyPressedProcedure;
...
public class TestMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		YaFnafmodMod.addNetworkMessage(TestMessage.class, TestMessage::buffer, TestMessage::new, TestMessage::handler);
	}
}
