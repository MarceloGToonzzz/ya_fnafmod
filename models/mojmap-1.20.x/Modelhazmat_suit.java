...
public class Modelhazmat_suit<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition BodyLayer = partdefinition.addOrReplaceChild("BodyLayer", CubeListBuilder.create().texOffs(0, 0)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(24, 0)
